        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form method="post" action="users_add_proc.php" class="user">
...
<div class="col-sm-6">
    ...
    <select name="account_status">
        ...
        <option value="0">Inactive</option>
                ...
                <!--<div class="col-md-12">
                  NOTE: Please don't forget to activate the newly added account.
                </div>-->
                <br>
                ...
                <hr>
                <a href="users_manage.php" class="btn btn-google btn-user btn-block">
                  Cancel
                </a>
              </form>
              <hr>
